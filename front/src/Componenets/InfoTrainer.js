...
export default class InfoTrainer extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  async componentDidMount() {
    try {
      ...
      console.log(json.filter((j) => j.trainerId === this.state.trainerId));

      this.setState(
        {
          pokemons: json.filter((j) => j.trainerId === this.state.trainerId),
          loading: false,
